            ...
            {newSummary.drawing && (
              <div style={{ marginTop: '10px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', columnGap: '12px', rowGap: '4px' }}>
                  ...
                  <span>{formatDate(newSummary.drawing.startDate)}</span>
                  
                  <span style={{ color: '#9e9e9e' }}>End:</span>
                  <span>{formatDate(newSummary.drawing.endDate)}</span>
                  
                  <span style={{ color: '#9e9e9e' }}>Duration:</span>
                  <span>{formatDuration(newSummary.drawing.duration)}</span>
                  
                  <span style={{ color: '#9e9e9e' }}>Tasks:</span>
                  <span>{newSummary.drawing.totalTasks}</span>
                  
                  <span style={{ color: '#9e9e9e' }}>Milestones:</span>
                  <span>{newSummary.drawing.totalMilestones}</span>
                </div>
              </div>
            )}
          </div>
